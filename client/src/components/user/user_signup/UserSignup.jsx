...
const UserSignup = () => {
    ...
    const [ signupData, setSignupData ] = useState({ firstName: '', lastName:'', email: '', mobileNo: '', adharImage: '', drivingLicense: '', password: '',confirmPassword: '' });
    ...
    const handleClear = () => {
        setSignupData({ firstName: '', lastName:'', email: '', mobileNo: '',adharImage: '', drivingLicense: '', password: '', confirmPassword: '' });
    ...
    return (
        <>
            <form className="flex-column border border-dark" id="register" >            
                <h2 className="fw-bold ms-5" id="regtitle">Signup</h2>
                ...
                <div className="row mt-1 ms-2" id="fullwidthinput">
                    ...
                    <div className="col-6">
                        <label for="file_input2" className="col-form-label fw-bold">Driving License image :</label> <br/>
                        <FileBase type="file" multiple={false} onDone={ ({ base64 }) => setSignupData({ ...signupData, drivingLicense: base64 }) } id='file_input2' /> <br />
                    </div>
                </div> 
