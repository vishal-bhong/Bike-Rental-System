...
export const signupUser = async (req, res) => {
    const { firstName, lastName, email, mobileNo, adharImage, drivingLicense, password, confirmPassword } = req.body;
    try {               
        ...
        const result = await User.create({ email: existingEmailForVerification.email, mobileNo, adharCardImage: adharImage, drivingLicenseImage: drivingLicense, password: hashedPassword, name: `${firstName} ${lastName}`}); 
